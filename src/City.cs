...
namespace CivOne
{
	...
	public class City : BaseInstance, ICity
	{
		...
		internal int TradeTotal => GetCityBreakdown().TradeTotal;
		internal int TotalTrade => GetCityBreakdown().TotalTrade;
		internal short TradeScience => GetCityBreakdown().TradeScience;
		internal short TradeLuxuries => GetCityBreakdown().TradeLuxuries;
		internal short TradeTaxes => GetCityBreakdown().TradeTaxes;
