...
// Extracted inner classes to separate Common/Reflect static dependencies from the mapper pipeline.
// If this grows, consider extracting to standalone files in Persistence.Factories.
...
// RuntimeGovernmentResolver wraps Reflect.GetGovernments() to isolate the
// Reflect static dependency from the mapper pipeline. If a standalone
// Persistence.Factories.ReflectFactory is introduced later, this can delegate to it.
