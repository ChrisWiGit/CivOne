...
namespace CivOne.Persistence.Model
{
    ...
    public class PlayerDto
    {
		...
		[Doc("Runtime handicap value used by the classic game balancing logic and barbarian spawn timing. Stored verbatim as an unsigned byte range.", 0, byte.MaxValue)]
