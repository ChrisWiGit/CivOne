...
namespace CivOne.Screens.Debug
{
	...
	{
		private const int DialogWidth = 136;
		...
		{
			PlayerSelected?.Invoke(Game.GetPlayer((byte)_menu.ActiveItem));
		}

		private void OnMenuCancel(object sender, EventArgs args)
		{
